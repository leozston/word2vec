...
//        learn.learnFile(new File("library/xh.txt"));
        learn.learnFile(new File("C:\\Users\\leoz\\Desktop\\hacker2017project\\info\\predata.txt"));
        System.out.println("use time " + (System.currentTimeMillis() - start));
        Map<String, float[]> wordVectorMap = learn.saveModel(new File("C:\\Users\\leoz\\Desktop\\hacker2017project\\info\\wordvector.txt"));

        Word2VEC w1 = new Word2VEC();
        w1.setWordMap(new HashMap<String, float[]>(wordVectorMap));
        ...
        System.out.print(w1.distance("北京"));
    }
}
